...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bardega - Painel Administrativo</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Painel de controle da Bardega" name="description" />
        ...
        <div>
            <div class="container-fluid p-0">
                <div class="row g-0">
                    ...
                    <div class="col-xl-9" style="background: url(/site/imagens/background-home-1.png); background-size: cover; background-position:center;">
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index.html" class="md-block auth-logo">
                                            <img src="{{asset('site/imagens/logo-branca.png')}}" alt="" width="200" class="mx-auto auth-logo-dark">
                                            <img src="{{asset('site/imagens/logo-branca.png')}}" alt="" width="200" class="mx-auto auth-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <form action="{{route('painel.logar')}}" method="post">
                                                ...
                                                <div class="mt-3 d-grid">
                                                    <button class="btn waves-effect waves-light" style="background-color: #F45028; color:white;" type="submit">Entrar</button>
                                                </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center text-white">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> <img class="ml-2 mt-n1" src="{{asset('/site/imagens/footer-seven.png')}}" alt=""></p>
                                    </div>
                                </div>
